window.onload = function(){
	...
	oLast.onclick = function(){
		...
		if($("#style") != null){
			...
			loadCssCode(`.Opage::before{ position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: -30px; z-index: -1; content: ''; background: url(./img2/${I}.jpg) no-repeat; background-size:100% 100%; filter: blur(20px); }`);
		}else{
			loadCssCode(`.Opage::before{ position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: -30px; z-index: -1; content: ''; background: url(./img2/${I}.jpg) no-repeat; background-size:100% 100%; filter: blur(20px); }`);
		}
		$("img")[0].src = `./img2/${I}.jpg`;
		$("img")[1].src = `./img2/${I}.jpg`;
		myMusic.pause();
		myMusic.src = `./music2/ogg/${I}.ogg`;
		Play = true;
